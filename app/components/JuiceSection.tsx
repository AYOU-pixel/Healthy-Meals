...
const juiceItems = [
  { name: "Mango smoothie",          image: "/18.jpg" },
  { name: "Berry smoothie",          image: "/6.jpg"  },
  { name: "Nutty & Berry smoothie",  image: "/19.jpg" },
  { name: "Kiwi & berry smoothie",   image: "/7.jpg"  },
  { name: "Protein smoothie",        image: "/17.jpg" },
];
